...
public class LambdaImplementation {
	...
	public static void main(String[] args) {
		...
		// Anonymous class, multiple instances created
		System.out.println("\nAnonymous class:");
		for (int i=0; i<5; i++) {
		...
		// Non-capturing lambda, one instance created
		...
		// Constant-capturing lambda, one instance created
	...
	public void foo() {
		...
		for (int i=0; i<5; i++) {
			// this-capturing lambda, many instances created!
