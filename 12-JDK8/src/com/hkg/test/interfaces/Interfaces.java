package com.hkg.test.interfaces;
...
public class Interfaces {
	public static void main(String[] args) {
		...
		// another static method in Comparator
		Comparator<Employee> nullThenbyName = Comparator.nullsFirst(byName);
		System.out.println("Null then:");
		System.out.println(nullThenbyName.compare(mike, louise));
		System.out.println(nullThenbyName.compare(mike, null));
	}
}
