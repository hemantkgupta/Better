...
public class DP22MaximumContiguousProductSubarray {
	...
	public static int maxSubarrayProduct(int arr[], int n)
	{
	    ...
	    /* Traverse throught the array. Following values are maintained after the ith iteration:
	       max_ending_here is always 1 or some positive product ending with prices[i]
	       min_ending_here is always 1 or some negative product ending with prices[i] */
	    for (int i = 0; i < n; i++)
	    {
	        ...
	        /* If element is negative. This is tricky
	           ...
	           or negative.
	           next min_ending_here will always be prev. max_ending_here * prices[i]
	           next max_ending_here will be 1 if prev min_ending_here is 1, otherwise 
	           next max_ending_here will be prev min_ending_here * prices[i] */
	        else
	        {
