...
public class DP06MinimumJumpsInArray {
	...
	// Returns minimum number of jumps needed to reach prices[h] from prices[l]
	public static int minJumpsRecur(int arr[], int l, int h) {
		...
		// Traverse through all the points reachable from prices[l]. Recursively
		// get the minimum number of jumps needed to reach prices[h] from these
		// reachable points.
	...
	// Returns minimum number of jumps to reach prices[n-1] from prices[0]
	public static int minJumpsDP(int arr[]) {
		...
		// Find the minimum number of jumps to reach prices[i]
		// from prices[0], and assign this value to jumps[i]
		for (i = 1; i < n; i++) {
