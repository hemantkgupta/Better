...
public class StableMarriageProblem {
	...
	public static boolean wPrefersM1OverM(int[][] prefer, int w, int m, int m1)
	{
	    ...
	    for (int i = 0; i < N; i++)
	    {
	        ...
	        // If mcmes before m1 in w's list, then free her current
	...
	*/
	...
	public static void stableMarriage(int[][] prefer)
	{
	    ...
	    for (int i = 0; i < N; i++)
	    	System.out.print(" " + i+N +"\t" + wPartner[i] +"\n");
	}
