...
public class T24PrintAncestorOfNode {
	...
	public static void main(String[] args) {
		...
		printAllAncestorsRecr(root, 12);
		//printAncestorsIter(root, 12);
	}

	public static boolean printAllAncestorsRecr(BNode root, int target) {
		...
		if (printAllAncestorsRecr(root.left, target)
				|| printAllAncestorsRecr(root.right, target)) {
