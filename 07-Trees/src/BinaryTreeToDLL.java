public class BinaryTreeToDLL {
	...
	public static BNode bintree2list(BNode root) {
			// Base case
			if (root == null)
				return root;
	...
	public static BNode bintree2listUtil(BNode root) {
		// Base case
		if (root == null)
			return root;
		...
		if (root.left != null) {
			...
			BNode left = bintree2listUtil(root.left);
		...
		if (root.right != null) {
			...
			BNode right = bintree2listUtil(root.right);
