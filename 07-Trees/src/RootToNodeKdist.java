...
public class RootToNodeKdist {
	...
	public static void main(String[] args) {
		...
		System.out.println(nodesKdistFromRoot(root, 3));
		printNodesKdistFromRoot(root, 3);
	} 
	
	public static int nodesKdistFromRoot(BNode root,int k){
		if (root == null)
			return 0;
		if(root!= null && k == 0)
			return 1;
		return nodesKdistFromRoot(root.left, k-1)+ nodesKdistFromRoot(root.right,k-1);
	}
