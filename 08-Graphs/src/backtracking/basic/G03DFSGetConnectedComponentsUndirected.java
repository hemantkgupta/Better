...
public class G03DFSGetConnectedComponentsUndirected {
	...
	private int[] id; // id[v] = id of the connected component containing v
	private int[] size; // size[id] = number of vertices for component with given id
	...
	public G03DFSGetConnectedComponentsUndirected(Graph G) {
		...
		for (int i = 0; i < G.V; i++) {
            ...
            // all the connected vertex from it
			if (!marked[i]) {
