...
public class G05DFSSingleSourceAllDestinationPathsUndirected {

	public static void main(String[] args) {
		Graph G = new Graph("tinyCG.txt");
		System.out.println(G);
		int s = 0;
		G05DFSSingleSourceAllDestinationPathsUndirected dfs = new G05DFSSingleSourceAllDestinationPathsUndirected(
				G, s);
	...
	public G05DFSSingleSourceAllDestinationPathsUndirected(Graph G, int s) {
		this.s = s;
		edgeTo = new int[G.V()];
