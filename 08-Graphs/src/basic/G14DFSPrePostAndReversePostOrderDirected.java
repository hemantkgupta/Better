...
public class G14DFSPrePostAndReversePostOrderDirected {
	  private boolean[] marked;          // marked[v] = has v been marked in dfs?
	    ...
	    public G14DFSPrePostAndReversePostOrderDirected(Digraph G) {
	        pre    = new int[G.V];
	        post   = new int[G.V];
	   ...
	   /* public DepthFirstOrder(EdgeWeightedDigraph G) {
	    ...
	    public static void main(String[] args) {
	        ...
	        G14DFSPrePostAndReversePostOrderDirected dfs = new G14DFSPrePostAndReversePostOrderDirected(G);
