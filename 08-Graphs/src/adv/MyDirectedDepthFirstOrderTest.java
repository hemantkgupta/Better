...
public class MyDirectedDepthFirstOrderTest {
	  private boolean[] marked;          // marked[v] = has v been marked in dfs?
	    ...
	    public MyDirectedDepthFirstOrderTest(Digraph G) {
	        pre    = new int[G.v];
	        post   = new int[G.v];
	   ...
	   /* public DepthFirstOrder(EdgeWeightedDigraph G) {
	    ...
	    public static void main(String[] args) {
	        ...
	        MyDirectedDepthFirstOrderTest dfs = new MyDirectedDepthFirstOrderTest(G);
